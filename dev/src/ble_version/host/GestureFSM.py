...
import time
from HIDController import MOUSE_LEFT, MOUSE_RIGHT
...
class KeyboardFSM:
    ...
    def __init__(self, hid):
        ...
        self.hid = hid                              # HID interface (USB or BLE) for sending keyboard input
